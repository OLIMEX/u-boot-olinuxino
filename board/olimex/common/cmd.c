...
static int do_config_list(struct cmd_tbl *cmdtp, int flag,
			  int argc, char *const argv[])
{
...
static int do_config_write(struct cmd_tbl *cmdtp, int flag,
			   int argc, char *const argv[])
{
...
static int do_config_erase(struct cmd_tbl *cmdtp, int flag,
			   int argc, char *const argv[])
{
...
static struct cmd_tbl cmd_config[] = {
...
static int do_monitor_list(struct cmd_tbl *cmdtp, int flag,
			   int argc, char *const argv[])
{
...
static int do_monitor_set(struct cmd_tbl *cmdtp, int flag,
			  int argc, char *const argv[])
{
...
static struct cmd_tbl cmd_monitor[] = {
	U_BOOT_CMD_MKENT(list, 1, 0, do_monitor_list, "", ""),
	U_BOOT_CMD_MKENT(set, 2, 0, do_monitor_set, "", ""),
};
#endif /* CONFIG_VIDEO_LCD_OLINUXINO */

static int do_olinuxino_opts(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	struct cmd_tbl *cp;
...
static int do_olinuxino_ops(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	struct cmd_tbl *cp;
